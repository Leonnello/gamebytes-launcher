...
public class MenuPanel extends JPanel {
    ...
    public MenuPanel(ActionListener startListener, GameWindow window) {
        ...
        try {
        InputStream imageStream = getClass().getResourceAsStream("/Game1_Snek/snake.png");
        if (imageStream != null) {
        ...
        quitButton.addActionListener(e -> {
            window.getLauncher().setVisible(true);
